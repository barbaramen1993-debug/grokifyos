...
return [
    ...
    'bridge_url' => rtrim(gos_env('GROKIFY_BRIDGE_URL', 'http://127.0.0.1:8876') ?? 'http://127.0.0.1:8876', '/'),
    'bridge_health_url' => gos_env('GROKIFY_BRIDGE_HEALTH', 'http://127.0.0.1:8876/health') ?? 'http://127.0.0.1:8876/health',
